...
```
    ...
    ## # A tibble: 50,400 × 6
    ##     week day_id day    activity_number activity_counts weekend_or_weekday
...
data), and there are 6 variables, which are week, day\_id, day,
activity\_number, activity\_counts, weekend\_or\_weekday that describing
